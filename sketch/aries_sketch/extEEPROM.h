 ...
 * 
 * Laurence Barker 16/02/2020
 * add 1MHz I2C clock speed capability 
 *                                                                             *
 * External EEPROM Library by Jack Christensen is licensed under CC BY-SA 4.0, *
 * http://creativecommons.org/licenses/by-sa/4.0/                              *
 *-----------------------------------------------------------------------------*/

#ifndef extEEPROMFast_h
#define extEEPROMFast_h
...
class extEEPROMFast
{
    ...
    public:
        ...
        enum twiClockFreq_t { twiClock100kHz = 100000, twiClock400kHz = 400000 , twiClock1000kHz = 1000000 };
        extEEPROMFast(eeprom_size_t deviceCapacity, byte nDevice, unsigned int pageSize, byte eepromAddr = 0x50);
